...
export const managementAccounts = mysqlTable("managementAccounts", {
  ...
  isInvestimentoOperacional: boolean("isInvestimentoOperacional").default(false).notNull(),  // Investimento operacional (ex: imóvel, reforma, expansão)
...
export const ifoodProductMappings = mysqlTable("ifoodProductMappings", {
  ...
  ifoodProductName: varchar("ifoodProductName", { length: 255 }),
  correctEan: varchar("correctEan", { length: 50 }),
